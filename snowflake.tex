...
One of the reasons is related to Snowflake itself,
and the other has to do with its interaction with Tor.
...
of who had access to those important keys to be so expansive.
...
otherwise could get away with hashing some aspect of the client (client ID) and using that to consistently assign to a bridge

A~client-chooses design
...
% A contrary view: "(More) Distributed servers" https://bugs.torproject.org/tpo/anti-censorship/pluggable-transports/snowflake/40248

As~of April 2023\todo{Update on publication.}, there are two backend bridges.
