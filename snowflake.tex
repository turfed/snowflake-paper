...
simply by blocking all communication,
...
from traffic that the censor wants to allow.
...
it replaces the encrypted content of encoded media frames
...
(this step is sometimes referred to as signaling).

A~client begins a Snowflake session by
sending a rendezvous message to the broker.
\todo{We could have referenced WebRTC term for this "Signaling Server" \url{https://developer.mozilla.org/en-US/docs/Web/API/WebRTC_API/Signaling_and_video_calling\#the_signaling_server}}
