...
that it would even be possible to build and sustain
a population of proxies large enough
...
Snowflake supports several types of proxies.
The primary one is the browser WebExtension,
