...
and the facilitator interaction in flash proxy~\cite[\S 3]{Fifield2012a}.
...
cannot use TURN server as choice of server would be distinguisher
self-measured with the help of STUN server
- unknown
- restricted
- unrestricted
probetest
