...
Some censors may be able to take those actions; others may not.
Advancing the state of the art of censorship circumvention
consists in finding techniques that push blocking
beyond the capabilities of more and more censors.

\todo[inline]{Add annotations for specific events in figures, like in \autoref{fig:user-counts}.}
...
Snowflake among them.
This effect is visiable at the left side of \autoref{fig:user-counts-ru}.
