...
WebRTC also offers \emph{media streams},
...
for example, the download should resume
without interruption on a new proxy.
...
session/\allowbreak reliability layer
between the temporary proxy connection
and the client's own streams.
