...
\subsection{Deployment history and user dynamics}
...
Snowflake was shipped in the alpha release series of Tor Browser
over the course of four years
before becoming part of the stable release.
...
cross-compiling and reproducible build environment.
...
While at this point Snowflake was available on major desktop platforms,
...
Meanwhile, Snowflake for Android had become available with
...
\todo{Find out when the first release of Snowflake in Orbot was.}
