...
We~currently support three rendezvous methods in Snowflake:
...
communication of short messages between microservices.
...
Clients write into a public, well-known queue which the broker reads from.
The broker responds to the client by creating a new, single-use queue
under the client's random session session identifier.
...
our \firstterm{bridge} to their \firstterm{portal}.
...
that censors prefer to traffic classification rules
...
{\textbf{How might proxy enumeration attacks be inhibited?}}
...
{\textbf{What is a good (family of) traffic shapes?}}
...
{\textbf{What is the design space of alternative models of Snowflake deployment?}}
...
{\textbf{Can traffic splitting improve performance or blocking resistance?}}
...
\todo{SQS rendezvous contributors.}
% https://keroserene.net/snowflake/technical/#history
