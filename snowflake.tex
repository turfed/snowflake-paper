...
See \autoref{fig:rendezvous}\todo{Replace provisional graphic.}.
...
\todo{The table is symmetric; show only half of it.
...
\centering
    ...
    \caption{Snowflake client poll counts by NAT type. \todo[inline]{Replace provisional figure.}}
