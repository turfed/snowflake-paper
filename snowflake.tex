...
are matched with the ``unrestricted'' bucket.\todo{Double check this number and update if needed.}
...
\todo[inline]{Make sure the axis labels make sense with new "bucket" framing.}
...
% $ grep '^2022-05-01.*,snowflake,' figures/users-global/userstats-bridge-transport-multi.csv
...
including Snowflake (the censor used a feature of the DTLS handshake).
