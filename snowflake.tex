...
to the client it looks like one round trip.
...
\todo[inline]{Replace ``rendezvous request,'' a term not used elsewhere.}
\end{figure}
...
taking care to change the externally visible hostname\todo{Audit ``domain name'' vs.\ ``hostname''.}
