...
As~you might expect, the attempted blocking
of various blocking-resilient transports
...
a~collaborator of our in Russia
isolated the traffic feature that was being used to detect Snowflake connections.
It~was DTLS fingerprinting
of the type cautioned about in \autoref{sec:fingerprinting}.
...
\mbox{supported\_groups} extension in Pion's DTLS Server Hello message.
This extension being included in Server Hello was a bug---it
...
was supposed to have been only in Client Hello---but
at any rate, it made DTLS connections with a Pion implementation
in the server role detectable as such.

The \mbox{supported\_groups} distinguisher is one
that had already been discovered by MacMillan et al.~\cite[\S 3]{arxiv.2008.03254}.
We~might have avoided this blocking event by proactively removing
...
Release to change fingerprint evaded blocking
