...
The top of the diagram is ``outer,'' closer to the network;
the bottom is ``inner,'' closer to the user.
...
per circumvention session, outliving any single proxy.
They maintain end-to-end state
and present an abstraction of a single long-lived tunnel.
Finally, over this tunnel
are transported the user's application streams,
for example web browsing and messaging.
