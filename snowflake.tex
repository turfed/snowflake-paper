...
Fifield and Gil Epner~\cite{arxiv.1605.08805} and
...
WebRTC's rich set of interacting protocols
creates a large attack surface for fingerprinting.

\begin{itemize}
\item Detection of rendezvous (e.g.\ TLS fingerprinting of domain fronting or AMP cache rendezvous)
\item WebRTC signaling
\item Contents of STUN messages
\item Choice of STUN servers
\item DTLS handshake fingerprinting
\item Choice of WebRTC data channel versus media channel
\end{itemize}
