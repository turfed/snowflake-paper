...
As~of November 2023, Snowflake supports an estimated 35,000 average concurrent users
% > library("tidyverse")
...
%   <date>     <chr>      <dbl>
% 1 2023-10-26 snowflake 34233.
% 2 2023-10-27 snowflake 34370.
% 3 2023-10-28 snowflake 34529.
% 4 2023-10-29 snowflake 34439.
% 5 2023-10-30 snowflake 34795.
% 6 2023-10-31 snowflake 34680.
...
% 1 2023-10-26 28.84 TB 28.73 TB 9.96 GB       185.39 GB      28.83 TB  28.55 TB   28.69 TB
% 2 2023-10-27 28.68 TB 28.57 TB 10.07 GB      188.27 GB      28.67 TB  28.38 TB   28.52 TB
% 3 2023-10-28 26.77 TB 26.66 TB 10.65 GB      197.87 GB      26.76 TB  26.47 TB   26.61 TB
% 4 2023-10-29 28.99 TB 28.89 TB 10.40 GB      197.07 GB      28.98 TB  28.69 TB   28.84 TB
% 5 2023-10-30 30.58 TB 30.47 TB 9.97 GB       192.56 GB      30.57 TB  30.28 TB   30.43 TB
% 6 2023-10-31 29.23 TB 29.12 TB 10.04 GB      189.98 GB      29.22 TB  28.93 TB   29.07 TB
...
%    <chr>            <dbl>           <dbl>        <dbl>         <dbl>
%  1 2023-01           1        0                   1.64        0.225
%  2 2023-02           1.00     0.0000131           1.94        0.154
%  3 2023-03           1        0                   1.42        0.280
%  4 2023-04           1        0                   1.15        0.152
%  5 2023-05           1.00     0.00204             1.23        0.113
%  6 2023-06           1.00     0.0000834           1.23        0.0734
%  7 2023-07           1        0                   1.07        0.0498
%  8 2023-08           1        0                   1.02        0.0568
%  9 2023-09           1        0                   1.00        0.0148
% 10 2023-10           1.00     0.000000552         1.01        0.0137
...
Their automatic classifier assigned high feature importance
to packet length fields,
and in fact did fairly well even without DTLS payload features.
...
for GNU/Linux
in Tor Browser~7.0a1 on \mbox{2017-01-24}\todo{Footnote URLs for this event and others in the history.}
...
and proxy support was added on \mbox{2020-11-17}.
% "Have a remote probe service to test snowflake proxy NAT compatability" https://bugs.torproject.org/tpo/anti-censorship/pluggable-transports/snowflake/40013
...
A~network censorship events may have the effect
...
which caused client rendezvous messages to fail to reach the broker.
...
As~of \mbox{2023-11-01},
Snowflake had transferred 10.9~PB of circumvention data.
% > library("tidyverse")
% > WANTED_FINGERPRINTS <- c(
%     "7659DA0F96B156C322FBFF3ACCC9B9DC01C27C73" = "snowman",
%     "5481936581E23D2D178105D44DB6915AB06BFB7F" = "snowflake-01",
...
%   date       read     write    `dirreq-read` `dirreq-write` good_read good_write good_avg
%   <date>     <chr>    <chr>    <chr>         <chr>          <chr>     <chr>      <chr>
% 1 2023-10-31 10.93 PB 10.98 PB 8.73 TB       161.39 TB      10.92 PB  10.81 PB   10.87 PB
...
(22\%~of bridge users) used Snowflake to connect to Tor.
% > library("tidyverse")
% > WANTED_FINGERPRINTS <- c(
%     "7659DA0F96B156C322FBFF3ACCC9B9DC01C27C73" = "snowman",
%     "5481936581E23D2D178105D44DB6915AB06BFB7F" = "snowflake-01",
%     "91DA221A149007D0FD9E5515F5786C3DD07E4BB0" = "snowflake-02"
%   )
% > DATE_RANGE <- as.Date(c("2023-10-25", "2023-11-01"))
% > userstats <- bind_rows(
...
%   <chr>  <chr>             <dbl>   <dbl>
% 1 bridge non-snowflake   958967    2.44
% 2 bridge snowflake       275558.   0.700
% 3 relay  NA            38134054   96.9
% > userstats %>% filter(mode == "bridge") %>% mutate(percent = 100 * users / sum(users))
% # A tibble: 2 × 4
%   mode   transport       users percent
%   <chr>  <chr>           <dbl>   <dbl>
% 1 bridge non-snowflake 958967     77.7
% 2 bridge snowflake     275558.    22.3
...
representing about 80\%\todo{Update percentage before submission.}
of 140,000 daily IP addresses.
% > library("tidyverse")
% > proxy_type <- read_csv("figures/proxies/proxy-type.csv", col_types = cols()) %>% filter("2023-10-01" <= date & date < "2023-11-01")
...
%   <chr>           <dbl>      <dbl>
% 1 badge          25257.  0.576
% 2 iptproxy      682229. 15.6
% 3 standalone    135349.  3.09
% 4 webext       3538605. 80.8
% 5 NA                 1   0.0000228
...
% https://metrics.torproject.org/networksize.csv?start=2023-10-01&end=2023-10-31
% date,relays,bridges
% 2023-10-29,7959,1881
% 2023-10-30,7964,1893
% 2023-10-31,8051,1889
