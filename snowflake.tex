...
pioneered the use of volunteer-operated WebRTC proxies.
...
and discuss if so.}
\todo{Very early versions of Lantern (circa 2014) also used
volunteer-operated proxies, not WebRTC though.
...
(2)~the filtering behavior of the peer's firewalls.
...
to condense these variations together with common firewall filtering behavior
...
for NAT behavior discovery, and use this to sort clients into one of two groups.
...
NAT behavior is not exposed as part of the WebRTC standard API for web browsers.
