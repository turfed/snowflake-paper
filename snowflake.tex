...
Common lessons are that having lines of communication
...
was blocked (by~TLS SNI) in some ISPs in Iran
...
A~reduction in users is visible at this time (\autoref{fig:user-counts-ir}).
...
In~any case, they did not have much of an effect.
