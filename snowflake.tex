...
Snowflake's general susceptibility to protocol fingerprinting
has been investigated by
Fifield and Gil Epner~\cite{arxiv.1605.08805},
and its DTLS features in particular by
MacMillan et~al.~\cite{arxiv.2008.03254}.
The former predates Snowflake's switch to Pion,
which changed protocol fingerprints at multiple layers.
The latter correctly anticipated features
