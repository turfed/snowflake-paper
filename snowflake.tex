...
This happened just before the deadline for this paper,
so~we cannot comment on any long-term effects,
but \autoref{fig:client-counts} shows a decline in users and bandwidth
of about~30\%.
