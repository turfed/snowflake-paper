...
The Snowflake client does not necessarily play the
DTLS client role in a WebRTC data channel:
depending on NAT, it may actually be the DTLS server,
the temporary proxy being the DTLS client.
