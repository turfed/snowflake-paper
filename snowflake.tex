...
Endpoint-dependent NAT mapping behaviour
(be it address-dependent or both address and port-dependent),
...
(sometimes referred to as symmetric NATs),
...
However, Tor has low speeds and lacks
