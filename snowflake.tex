...
\todo[inline]{Redo the color palette here and in \autoref{fig:proxy-type}: the blue and purple are too similar with CVD.}
\end{figure}
...
Caveats of geolocation, \href{https://bugs.torproject.org/tpo/anti-censorship/pluggable-transports/snowflake/40207\#note_2844116}{IR/US confusion}.}
...
\todo[inline]{Try these graphs with equal horizonal scaling.}
}
\end{minipage}}
\end{figure}
