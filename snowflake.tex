...
- nothing essential to KCP/smux; has familiarity and demonstrated success in other systems; but might be swapped out with e.g.\ embedded QUIC or another (end-to-end) layer of SCTP
