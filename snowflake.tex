...
visible in \autoref{fig:user-counts-tm} was caused by
a partial unblocking of the broker front domain on \mbox{2023-05-03}.
We~realized this only in retrospect,
by~looking at logs from Censored Planet,\todo{Cite Censored Planet.}
...
cannot find its own ICE candidate addresses (\autoref{sec:ice}),
...
Though do not have continuous measurements to be sure,
we~suspect that the STUN port blocking began on \mbox{2022-08-03}
and precipitated the drop seen there in \autoref{fig:user-counts-tm}.
