...
The initial blocking event in December 2021
led to Snowflake's first surge in users.
}
...
was blocked in a subset of ISPs in Russia on \mbox{2021-12-01}~\cite{ooni-2021-russia-blocks-tor}.
...
besides Snowflake,
some servers supporting
the blocking-resistant transports meek and obfs4,
as well as the IP addresses of a portion
of unobfuscated Tor relays and bridges,
were blocked.
As~might be expected, the attempt to block
Tor's blocking-resilient transports
was less than totally successful,
and the ultimate effect was to increase the number of users in Russia
using circumvention protocols to access Tor.
What concerns us here is the mechanism of Snowflake's detection and blocking.
...
% "Since the release of Tor Browser 12.0.3 on 2023-02-15 there has been an increase in users from Russia on both bridges." https://gitlab.torproject.org/tpo/anti-censorship/censorship-analysis/-/issues/40030#note_2893870
