...
\fontsize{\urlfootnotesize}{\urlfootnotesize}\selectfont\url{#1}
}}
...
\todo[inline]{Change TB/day to Gbit/s.}
...
}\todo{Break URLs (in footnotes) after `\#', not before.}
...
testers reported that Snowflake continued to work\urlfootnote{
...
after which the number of users in Russia began to recover\urlfootnote{
% "Since the release of Tor Browser 12.0.3 on 2023-02-15 there has been an increase in users from Russia on both bridges."
https://bugs.torproject.org/tpo/anti-censorship/censorship-analysis/40030\#note_2893870
}.
