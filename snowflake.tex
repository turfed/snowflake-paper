...
\todo{Move up into \autoref{sec:proxies}.}
...
\caption{
Proxy IP address churn in January 2023.
The upper, darker line shows the number
of unique proxy IP addresses in 24-hour windows,
at intervals of 1~hour (the windows overlap).
The lower, fainter lines show,
relative to a reference window,
how many IP addresses subsequent windows
have in common with the reference,
at 1-hour intervals up to 40 hours later.
After 24 hours have elapsed,
more than half the proxy pool has turned over
with new addresses.
}
