...
In the abstract architecture of \autoref{sec:mechanics}, the bridge
...
Unlike many other proxy systems,
...
multiple servers, each of which handles a fraction of client traffic.
...
the other, more constraining, is an artifact of its interaction with Tor.
